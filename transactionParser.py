...
class TransactionParser:
    ...
    def maximum_reward_for_month(self) -> int:
        """
        """

    def rule_applicable(self, reqs: List[Tuple[str, int]]) -> bool:
        """
        checks if rule is applicable
        """
        for merchant, amount in reqs:
            if self._parsed_transactions[merchant] < amount:
                return False
...
print("rule applicable: ", t.rule_applicable(DEFAULT_RULES[0]["Reqs"]))
